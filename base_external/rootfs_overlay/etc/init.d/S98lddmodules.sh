...
case "$1" in 
    start)
        echo "Setting up hello, faulty, and scull..."
        module_load /lib/modules/hello.ko
        module_load /lib/modules/faulty.ko
        scull_load /lib/modules/scull.ko
        ;;
    stop)
        echo "Closing hello, faulty, and scull..."
        module_unload hello
